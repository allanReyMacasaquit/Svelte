...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="montserrat text-blue-600">Allan Rey</span> Macasaquit
                <br />Full Stack
                <span class="poppins text-blue-600">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-blue-400"> favorite Front-End</span> includes HTML,CSS and JavaScript
                (SvelteKit), (React), TailwindCSS, MaterialUI, <span class="text-blue-400"> for Back-End</span> Node.js + Express.js, 
                Firebase/Firestore, MongoDb.
            </p>
            <button
                class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl montserrat hover:text-white relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950"
            >
                <div
                    class="absolute top-0 right-full w-full h-full bg-blue-600  group-hover:translate-x-full z-0 duration-200"
                />
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    Echo Store is a a merchanising store created with <strong
                        class="text-blue-400"
                        >React.js, Stripe & Node.js + Express.js!</strong
